...
// 표준 약관 문구 — /terms, /privacy 페이지와 회원가입 동의 모달의 단일 출처.
// TODO(출시 전): 법무 검토 후 확정.
export const TERMS: Record<TermsKey, TermsDoc> = {
  service: {
    ...
    sections: [
      {
        heading: "제1조 (목적)",
        body: "본 약관은 DevPass(이하 \"회사\")가 제공하는 채용·커리어 관련 서비스(이하 \"서비스\")의 이용과 관련하여 회사와 회원 간의 권리, 의무 및 책임사항을 규정함을 목적으로 합니다.",
      },
      {
      ...
      {
        heading: "부칙",
        body: "본 약관은 2026년 7월 2일부터 시행합니다. 회사는 약관을 개정할 수 있으며, 개정 시 시행일과 개정 사유를 명시하여 시행일 7일 전부터 서비스 내에 공지합니다.",
      },
    ],
  },
  privacy: {
    ...
    sections: [
      ...
      {
        heading: "5. 개인정보 관련 문의",
        body: "개인정보 처리에 관한 문의는 worlddev61@gmail.com 으로 연락해 주세요. 본 방침은 2026년 7월 2일부터 적용되며, 변경 시 서비스 내에 공지합니다.",
      },
    ],
  },
  marketing: {
