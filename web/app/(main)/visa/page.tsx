      ...
      <div className="grid gap-3 sm:grid-cols-2">
        {VISA_GUIDES.map((g) => (
          <Link
            key={g.slug}
            href={`/visa/${g.slug}`}
            className="group rounded-2xl border border-border bg-card p-6 transition-colors hover:border-primary/40 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
          >
