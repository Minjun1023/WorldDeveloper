// 카피는 실데이터/실동작에 맞춰 정직하게: 6축 가중치는 실제 엔진이 스택·비자 비중을 더 크게 두므로
// 특정 퍼센트를 단정하지 않는다. 명부 검증은 US USCIS · UK Home Office · NL IND 대조.
const FAQS = [
  {
    q: "정부 명부 검증이란 무엇인가요?",
  ...
  {
    q: "6축 매칭 점수는 어떻게 계산하나요?",
    a: "스택·비자·지역·레벨·연봉·의미 6개 축의 가중 평균으로 계산합니다. 스택과 비자 비중이 가장 크며, 보유 기술과 공고 키워드 일치도, 비자 가능성, 희망 지역·레벨 부합, 연봉 적합도, 직무 설명과의 의미적 유사도를 반영해요. 프로필을 작성하면 내 기준으로 정확한 점수를 확인할 수 있습니다.",
  },
  {
    q: "무료로 사용할 수 있나요?",
    a: "공고 검색 및 기본 정보는 무료이며 회원가입 없이 이용할 수 있어요. 6축 매칭 점수, 맞춤 추천, 공고 관리 칸반 보드는 프로필 작성 후 이용 가능합니다. 현재 모든 기능을 무료로 제공하고 있습니다.",
  },
];
