...
const FAQS = [
  ...
  },
  {
    ...
    a: "스택·지역·레벨·연봉·의미 5개 축의 가중 평균으로 계산합니다. 보유 기술과 공고 키워드 일치도(스택), 희망 지역 부합, 레벨·시니어리티, 연봉 적합도, 직무 설명과의 의미적 유사도를 반영해요. 비자 스폰서십은 매칭 축이 아니라 기본 필터라 모든 공고가 충족하며, 프로필을 작성하면 내 기준으로 정확한 점수를 확인할 수 있습니다.",
  },
  {
    q: "무료로 사용할 수 있나요?",
    a: "공고 검색 및 기본 정보는 무료이며 회원가입 없이 이용할 수 있어요. 5축 매칭 점수, 맞춤 추천, 공고 관리 칸반 보드는 프로필 작성 후 이용 가능합니다. 현재 모든 기능을 무료로 제공하고 있습니다.",
  },
];
