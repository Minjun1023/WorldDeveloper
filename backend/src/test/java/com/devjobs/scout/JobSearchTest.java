...
class JobSearchTest {
    ...
    void relevanceRanksTitleAboveDescription() {
        ...
        JobListResponse res = service.search("backend", null, null, null, null, null, 1, 20);
    ...
    void matchesCompanyName() {
        ...
        JobListResponse res = service.search("stripe", null, null, null, null, null, 1, 20);
    ...
    void matchesTag() {
        ...
        JobListResponse res = service.search("kubernetes", null, null, null, null, null, 1, 20);
    ...
    void recentSortOrdersByPostedAt() {
        ...
        JobListResponse res = service.search("backend", null, null, null, "recent", null, 1, 20);
    ...
    void filterAppliesWithKeyword() {
        ...
        JobListResponse res = service.search("backend", null, null, true, null, null, 1, 20);
    ...
    void noKeywordReturnsActiveJobs() {
        ...
        JobListResponse res = service.search(null, null, null, null, null, null, 1, 20);
